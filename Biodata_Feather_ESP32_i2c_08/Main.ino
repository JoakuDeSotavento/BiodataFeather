...
void loop() {
  ...
  //Manage Sensors over I2C, periodic reading of sensors
  //create unsigned long prevSensorMillis and senseTime
  //can have multiple time variables for various sensors
  //write a 'read' routine for each sensor
  //be sure to include any sensor 'setup' in setup()
  //store the data to variables and output to the database
  if(currentMillis>prevSensorMillis+senseTime){
    //update timer info
