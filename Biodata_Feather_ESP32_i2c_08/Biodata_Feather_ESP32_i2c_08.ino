//   SymBioWare =- a platform for biodata sonification featuring i2c sensors
...
8.  lets add sensors using stemma connectors and i2c, create a template and a polling/timing method for reading
9.  get super fancypants and start sending data up to a database woot!
***/
// Wifi Credentials ~~~~~~~~~~~!!!!
...
byte debugSerial = 0;        //debugging serial messages
...
const byte interruptPin =   44; //12;  //galvanometer input
...
//for managing periodic sensors
//add more variables if diff sensors have diff poll timings
unsigned long prevSensorMillis = 0;
unsigned long senseTime = 10000;
